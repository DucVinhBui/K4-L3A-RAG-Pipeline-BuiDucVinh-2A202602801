...
|---|---|---|---|
| Bổ sung nguồn tin tức | Thêm 3–5 bài ctt.hust.edu.vn, chuẩn hoá và reindex | `src/task2_crawl_news.py`, `data/standardized/news/` | Chưa bắt đầu |
